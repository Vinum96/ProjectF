    ...
    <div className={styles.contactInfo_container}>
      ...
      <div className={styles.links_container}>
        <div className={styles.link_container}>
          ...
          <a className={styles.big_txt} href="tel">+49 999 999 99 99</a>
        </div>

        <div className={styles.link_container}>
          <p className={styles.small_txt}>Socials</p>
          <div className={styles.img_container}>
            <a className={styles.img} href="https://www.instagram.com/"><img src={instagram} alt="icon" /></a>
            <a className={styles.img} href="https://www.whatsapp.com/"><img src={whatsapp} alt="icon" /></a>
          </div>
        </div>
